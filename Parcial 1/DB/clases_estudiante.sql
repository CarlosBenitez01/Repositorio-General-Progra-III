...
CREATE TABLE `estudiante` (
  ...
  `Estuser` varchar(45) DEFAULT NULL,
  `Estpass` varchar(45) DEFAULT NULL,
...
INSERT INTO `estudiante` VALUES (1,'Carlos','Benitez',NULL,NULL),(2,'Francisco','Quintanilla',NULL,NULL),(3,'Carlos','Benitez','Prueba','5f4dcc3b5aa765d61d8327deb882cf99');
